...
router.get("/contact", function (req, res) {
  DigitalMarketingCollection.doc("contact_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/blogs", function (req, res) {
  DigitalMarketingCollection.doc("blog_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/blog-details/*", function (req, res) {
  const page_url = req.originalUrl.split("/").reverse()[0];
  BlogCollection.where("page_url", "==", page_url)
    .get()
    .then((response) => {
      if (response.empty) {
        res.render("under-maintenance.ejs");
...
router.get("/customer-agreement", function (req, res) {
  DigitalMarketingCollection.doc("customer_agreement_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/vendor-agreement", function (req, res) {
  DigitalMarketingCollection.doc("vendor_agreement_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/hotels", function (req, res) {
  DigitalMarketingCollection.doc("hotel_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/hotel-booking/*", function (req, res) {
  ...
  HotelCollection.where("page_url", "==", page_url)
...
router.get("/hotel-agreement", function (req, res) {
  DigitalMarketingCollection.doc("hotel_agreement_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/packages", function (req, res) {
  DigitalMarketingCollection.doc("package_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/package-booking/*", function (req, res) {
  ...
  PackageCollection.where("page_url", "==", page_url)
    .where("package_location", "==", package_location)
    .get()
        ...
        if (packageData.length) {
          res.render("package-booking", {
            ...
            package_image_collections:
              packageData[0]["package_image_collections"],
...
router.get("/package-agreement", function (req, res) {
  DigitalMarketingCollection.doc("package_agreement_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/privacy-policy", function (req, res) {
  DigitalMarketingCollection.doc("privacy_policy_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/terms-and-conditions", function (req, res) {
  DigitalMarketingCollection.doc("terms_and_conditions_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/cancellation-and-refund-policy", function (req, res) {
  DigitalMarketingCollection.doc("cancellation_and_refund_policy_page")
    .get()
    .then((response) => {
      if (!response.exists) {
        res.render("under-maintenance.ejs");
...
router.get("/payment/*", function (req, res) {
  const url_data = req.originalUrl.split("/").reverse();
  const document_id = url_data[0] ? url_data[0] : "";
  BookingCollection.where("document_id", "==", document_id)
      ...
      if (bookingResponse.empty) {
        ...
        if (bookingData.length) {
          res.render("payment", {
            ...
            title: "Payment Confirmation",
            description:
              "Pay booking amount to NSG TAXI. Best taxi service provider in india.",
            keywords:
              "Booking Payment, Customer Payment, Bill Payment, Trip Payment",
            first_name: bookingData[0]["first_name"],
            last_name: bookingData[0]["last_name"],
            email: bookingData[0]["email"],
            mobile: bookingData[0]["mobile"],
            trip_type:
              bookingData[0]["round_way_trip"] == "1" ? "Round Way" : "One Way",
            car_type: bookingData[0]["car_type"],
            pickup_address: bookingData[0]["pickup_address"],
            drop_off_address: bookingData[0]["drop_off_address"],
            actual_distance: bookingData[0]["actual_distance"],
      ...
      .then((response) => {
        ...
        if (
          ...
          res.render("payment-status", {
            ...
            title: "Payment Status",
            description:
              "Booking payment status of NSG TAXI. Best taxi service provider in india.",
            keywords:
              "Booking Payment Status, Customer Payment Status, Bill Payment Status, Trip Payment Status",
            transaction_status: "success",
            transaction_amount: parseInt(response.order.amount / 100, 10),
            transaction_id: response.payment.id,
            first_name: response.booking.first_name,
